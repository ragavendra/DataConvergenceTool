...
//DMT query
$sDMTQuery = "SELECT * FROM sap_qa1 WHERE SystemStatus = 'INST' ORDER BY MeterNumber ASC";
$sDMTQuery = "";

$sTableName="sap_qa1";

//DMT query row count
$sDMTRowCountQuery = "SELECT * FROM sap_qa1 WHERE SystemStatus = 'INST'";
...
<th>Meter Application Group(s)</th>
