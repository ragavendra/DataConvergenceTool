...
<head>
  ...
  <h1>AFCE - MDMS Meter Update Tool</h1>
...
<body>
  <table>
    ...
    <form name="MDMSMeterUpdate" method="post" action="MDMSMeterUpdateQuery.php" onsubmit="return validateForm()">
      ...
      <tr>
        <td>Meter Number(s):&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><textarea class="FormElement" name="MeterNumber" id="MeterNumber" cols="7" rows="5" maxlength="48" WRAP="SOFT"></textarea></td>
