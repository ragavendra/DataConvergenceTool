...
//get conn id
$sMDMSConnStr = oci_parse($sMDMSConn, $MDMS_Query);
oci_execute($sMDMSConnStr);
$MDMSrow = oci_fetch_array($sMDMSConnStr, OCI_ASSOC+OCI_RETURN_NULLS);
...
oci_free_statement($sMDMSConnStr);
oci_close($sMDMSConn);
