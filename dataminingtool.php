...
<tr>
<td>Installation: </td><td><input type="text" size="12" maxlength="12" name="Installation"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. 316332</td>
</tr>

<tr>
<td><label for="Material">Meter Type: </td><td><input type="text" size="4" maxlength="4" name="Material" id="Material"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. P264</td>
</tr>

<tr>
<td>Register Group: </td><td><input type="text" size="8" maxlength="8" name="RegisterGroup" id="RegisterGroup"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. P264A_01</td>
</tr>

<tr>
<td>Rate Category: </td><td><input type="text" size="12" maxlength="12" name="RateCategory"></td>>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. BCRSE1101</td>
</tr>

<tr>
<td>Billing Class: </td><td><input type="text" size="12" maxlength="12" name="BillingClass"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. BCRS</td>
</tr>

<tr>
<td>MRUnit: </td><td><input type="text" size="12" maxlength="12" name="MRUnit"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. B055401B</td>
</tr>

<tr>
<td>Move In Date from: </td><td><input type="date" size="10" maxlength="10" name="MoveInDate"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. 2012-12-31</td>
<td>To: <input type="date" size="10" maxlength="10" name="MoveInDateTo"></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>

<tr>
<td>Limit rows: </td><td><input type="number" size="6" maxlength="6" name="RowLimit"></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;eg. 123</td>
</tr>
